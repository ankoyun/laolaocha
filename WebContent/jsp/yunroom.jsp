...
<ul class="list-unstyled">
  <li class="media">
    <img class="mr-3" src="images/room2.JPG" style="width:400px;height:400px">
    <div class="media-body">
      <h5 class="mt-0 mb-1">韵静阁</h5>
                位于茶室二楼右侧，分为内外两部分。适合多人聚会。在这里聊天谈心，诉说这些年各自不同的经历。
      <h6>可容纳人数：8-10人</h6>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <a class ="btn btn-outline-primary" href="BookRoomAction?roomID=4" role="button">确认</a>
		      </div>
		    </div>
		  </div>
		</div>
