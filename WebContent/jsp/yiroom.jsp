...
<ul class="list-unstyled">
  <li class="media">
    <img class="mr-3" src="images/room4.JPG" style="width:400px;height:400px">
    <div class="media-body">
      <h5 class="mt-0 mb-1">怡韵阁</h5>
                位于茶室二楼中侧，室内光线明亮，无论何时，在这都犹如晴天。
      <h6>可容纳人数：5-6人</h6> 
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <a class ="btn btn-outline-primary" href="BookRoomAction?roomID=5" role="button">确认</a>
		      </div>
		    </div>
		  </div>
		</div>
