...
<ul class="list-unstyled">
  <li class="media">
    <img class="mr-3" src="images/room.JPG" style="width:400px;height:400px">
    <div class="media-body">
      <h5 class="mt-0 mb-1">岚云阁</h5>
                位于茶室二楼左侧，环境幽静。约上你的挚友，可让其品尝你亲手所泡制的茶，别具真情。
      <h6>可容纳人数：2人</h6>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <a class ="btn btn-outline-primary" href="BookRoomAction?roomID=6" role="button">确认</a>
		      </div>
		    </div>
		  </div>
		</div>
